...
const Collections: React.FC<CollectionsProps> = ({ collections, cardReports }) => {
  ...
  return (
    <div>
      {collections.map((cardNumber, index) => {
        const card = cardReports.find((report) => report.cardNumber.toString() === cardNumber);
        if (!card) return null;
        return (
